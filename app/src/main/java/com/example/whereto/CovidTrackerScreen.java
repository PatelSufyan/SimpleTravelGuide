...
import com.example.whereto.api.ApiUtilities;
import com.example.whereto.api.CountryData;
...
public class CovidTrackerScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_covid_tracker_screen);
        ...
        ApiUtilities.getApiInterface().getCountryData()
                .enqueue(new Callback<List<CountryData>>() {
                    ...
                    public void onFailure(Call<List<CountryData>> call, Throwable t) {
                        Toast.makeText(CovidTrackerScreen.this,"Error : "+t.getMessage(),Toast.LENGTH_SHORT).show();
